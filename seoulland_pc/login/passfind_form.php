...
<body>
  ...
  <div id="content">
      ...
      <img class="bk" src="images/bk.png" alt="">
       <p class="des">비밀번호를 잊으셨나요?</p>
       
		<div id="idfind_form">
		      <ul>
                   <li><label for="id" class="hidden">아이디</label><input type="text" id="id" name="id" class="login_input" placeholder="아이디를 입력하세요 (testid)"></li>
                  ...
                  <li><a class="find_btn" href="#none"><i class="fas fa-search"></i> 비밀번호 찾기</a></li>
